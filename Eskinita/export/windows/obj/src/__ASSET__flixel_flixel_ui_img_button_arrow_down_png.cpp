...
HX_DEFINE_STACK_FRAME(_hx_pos_c3174dcb7fd665f5_302_new,"__ASSET__flixel_flixel_ui_img_button_arrow_down_png","new",0x3b7e342a,"__ASSET__flixel_flixel_ui_img_button_arrow_down_png.new","lime/_internal/macros/AssetsMacro.hx",302,0xc651f030)
HX_LOCAL_STACK_FRAME(_hx_pos_c3174dcb7fd665f5_156_boot,"__ASSET__flixel_flixel_ui_img_button_arrow_down_png","boot",0xcb087128,"__ASSET__flixel_flixel_ui_img_button_arrow_down_png.boot","lime/_internal/macros/AssetsMacro.hx",156,0xc651f030)
...
void __ASSET__flixel_flixel_ui_img_button_arrow_down_png_obj::__construct( ::lime::graphics::ImageBuffer buffer, ::Dynamic offsetX, ::Dynamic offsetY, ::Dynamic width, ::Dynamic height, ::Dynamic color, ::lime::graphics::ImageType type){
            	HX_STACKFRAME(&_hx_pos_c3174dcb7fd665f5_302_new)
HXLINE( 303)		super::__construct(null(),null(),null(),null(),null(),null(),null());
HXLINE( 305)		this->_hx___fromBytes(::haxe::Resource_obj::getBytes(HX_("__ASSET__:image___ASSET__flixel_flixel_ui_img_button_arrow_down_png",6a,37,2c,53)),null());
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_c3174dcb7fd665f5_156_boot)
HXDLIN( 156)		resourceName = HX_("__ASSET__:image___ASSET__flixel_flixel_ui_img_button_arrow_down_png",6a,37,2c,53);
            	}
}
