...
HXLINE(  19)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("Eskinita",14,2a,05,9f),::ApplicationMain_obj::create_dyn());
...
HXLINE(  38)		app->meta->set(HX_("build",2e,db,ea,ba),HX_("24",c2,2b,00,00));
HXLINE(  39)		app->meta->set(HX_("company",3d,15,69,83),HX_("HaxeFlixel",42,8f,0c,ac));
HXLINE(  40)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("Eskinita",14,2a,05,9f));
HXLINE(  41)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Eskinita",14,2a,05,9f));
...
HXLINE(  49)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Eskinita",14,2a,05,9f))
