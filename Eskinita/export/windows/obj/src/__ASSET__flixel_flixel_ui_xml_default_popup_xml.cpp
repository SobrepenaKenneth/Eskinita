...
HX_DEFINE_STACK_FRAME(_hx_pos_12cc29ec0040cf38_51_new,"__ASSET__flixel_flixel_ui_xml_default_popup_xml","new",0x52c31055,"__ASSET__flixel_flixel_ui_xml_default_popup_xml.new","lime/_internal/macros/AssetsMacro.hx",51,0xc651f030)
HX_LOCAL_STACK_FRAME(_hx_pos_12cc29ec0040cf38_156_boot,"__ASSET__flixel_flixel_ui_xml_default_popup_xml","boot",0x10043a9d,"__ASSET__flixel_flixel_ui_xml_default_popup_xml.boot","lime/_internal/macros/AssetsMacro.hx",156,0xc651f030)

void __ASSET__flixel_flixel_ui_xml_default_popup_xml_obj::__construct( ::Dynamic length,::Array< unsigned char > bytesData){
            	HX_STACKFRAME(&_hx_pos_12cc29ec0040cf38_51_new)
HXLINE(  52)		 ::haxe::io::Bytes bytes = ::haxe::Resource_obj::getBytes(HX_("__ASSET__:file___ASSET__flixel_flixel_ui_xml_default_popup_xml",4a,b4,43,80));
...
{
{
            	HX_STACKFRAME(&_hx_pos_12cc29ec0040cf38_156_boot)
HXDLIN( 156)		resourceName = HX_("__ASSET__:file___ASSET__flixel_flixel_ui_xml_default_popup_xml",4a,b4,43,80);
            	}
}
