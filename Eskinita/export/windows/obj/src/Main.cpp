...
HXLINE(  11)		this->addChild( ::flixel::FlxGame_obj::__alloc( HX_CTX ,1280,720,::flixel::util::typeLimit::_NextState::InitialState_Impl__obj::fromType(::hx::ClassOf< ::PlayState >()),null(),null(),null(),null()));
            	}
