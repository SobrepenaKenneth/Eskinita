...
HX_DEFINE_STACK_FRAME(_hx_pos_0bb624e4e0669b45_51_new,"__ASSET__flixel_flixel_ui_xml_defaults_xml","new",0x9f4395df,"__ASSET__flixel_flixel_ui_xml_defaults_xml.new","lime/_internal/macros/AssetsMacro.hx",51,0xc651f030)
HX_LOCAL_STACK_FRAME(_hx_pos_0bb624e4e0669b45_156_boot,"__ASSET__flixel_flixel_ui_xml_defaults_xml","boot",0xb3f88dd3,"__ASSET__flixel_flixel_ui_xml_defaults_xml.boot","lime/_internal/macros/AssetsMacro.hx",156,0xc651f030)

void __ASSET__flixel_flixel_ui_xml_defaults_xml_obj::__construct( ::Dynamic length,::Array< unsigned char > bytesData){
            	HX_STACKFRAME(&_hx_pos_0bb624e4e0669b45_51_new)
HXLINE(  52)		 ::haxe::io::Bytes bytes = ::haxe::Resource_obj::getBytes(HX_("__ASSET__:file___ASSET__flixel_flixel_ui_xml_defaults_xml",66,61,52,48));
...
{
{
            	HX_STACKFRAME(&_hx_pos_0bb624e4e0669b45_156_boot)
HXDLIN( 156)		resourceName = HX_("__ASSET__:file___ASSET__flixel_flixel_ui_xml_defaults_xml",66,61,52,48);
            	}
}
